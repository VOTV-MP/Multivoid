...
| `votv-ue4ss-switch-decision-QF-WIP-2026-07-26.md` | **UNFINISHED /qf (15 rounds, NOT converged).** Should the substrate move onto UE4SS's C++ API? Measured: 2,404 replaceable LOC (1.6%), 5 repair commits in 1,282 (2 of which a framework absorbs), F2 un-buildable for outsiders (private UEPseudo). Decision is the USER's and is NOT taken; §6 lists the residual actions. |
