// ue_wrap/actors/begin_equipment.h -- give the LOCAL player a New-Game equipment item via the
// game's OWN equip path. Wraps the exact two UFunctions the gamemode's begin-equipment loop chains
