...
// where. Every finder that scans GUObjectArray end to end (FindObject, FindClass on a miss, FindFunction,
...
// (FindClassDefaultObject calls FindObject) names that finder.
...
// The call-site table's slots: the seven finders have about 1200 call sites in the source, and the
