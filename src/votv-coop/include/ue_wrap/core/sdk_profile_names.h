...
inline constexpr const wchar_t* UiMenuButtonStartProp = L"button_start";      // UButton*  @ +0x2E0 (NEW GAME -- the inject derives its parent VerticalBox from this button's slot. It does NOT clone its style: cloning tex_btnStart was TRIED and reverted -- that pointer is null at some inject timings and fell through to a Roboto/centered/white default. engine_widget.cpp:394-424 sets the measured constants instead.)
