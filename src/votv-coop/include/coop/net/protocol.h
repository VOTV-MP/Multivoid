...
inline constexpr uint16_t kProtocolVersion = 128; // v128 (2026-07-25, consume b127: the WHOLE ini workstream -- arc 3 const Row& ratchet + arc 4 T8 catalog). Prior: v127 (consume b126, arcs 1+2); v126 (consume b125, drill-matrix, retracted); v125 (2026-07-22, R11b container extraction):
