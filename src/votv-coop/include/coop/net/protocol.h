...
static_assert(sizeof(WorldActorSpawnPayload) == 104,
              "WorldActorSpawnPayload must be 104 bytes (v142: EntitySpawnPayload's keep-set, minus the "
              "three NPC-only fields the WA lane always left at 0)");
