...
//             host's canonical array to come back once for each of the two, still the array its own ops
//             left (a denied op's canonical would differ), its ACKED line. A joiner
