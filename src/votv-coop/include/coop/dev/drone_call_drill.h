// coop/dev/drone_call_drill.h -- [dev] the drone console drill: a client's press on the garage
...
//             host's "[DRONE-CALL] PRESSED console" line is the lane's verdict. The drone's own
