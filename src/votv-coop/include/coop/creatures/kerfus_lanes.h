// coop/creatures/kerfus_lanes.h -- the plain kerfur's (the Kerfus, p_kerfus_C) four lanes, wired in
// one place: its brain refused on a client (kerfus_brain), its state and drive from the host
// (kerfus_state), a client's verbs as the host's (kerfus_intent), and a Kerfus a client turned on
// following that client (kerfus_follow). Each registers its watches (Install,
