...
// and destroys it, and the conversion poll never sees it.
//
...
// ClaimConversionGhosts and poll-visible. CLIENT-only and GAME-THREAD-only, no mutex; the
// client-mint gate keeps the twin out of the Registry's actor-to-eid map, so after adoption it is
// purely a mirror. The prop-form analogue of coop/creatures/npc_adoption.h.
