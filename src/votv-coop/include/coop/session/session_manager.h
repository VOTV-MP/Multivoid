...
// The mod's version identity is a pair: GameTarget is the VOTV cook this build targets
// (generated coop/version.h), and the build number is kProtocolVersion, which moves exactly
// when compatibility moves. DisplayVersion is the composite the menu shows.
