...
// CLIENT: the host's last word on its drone's Active -- its connect snapshot or the stream, which
// carries every change of it: 1 in flight, 0 parked, -1 before any word this session. The mirror's own
