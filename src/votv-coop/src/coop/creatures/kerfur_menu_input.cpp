...
void OnUseInputPre(void* self, void* /*function*/, void* /*params*/) {
    ...
    // host OnCommandRequest -> ExecuteHostCommand, which runs the verb with the kerfur serving this
    // client. This seam is CLIENT-only; the host's own use is stream-mirrored.
