...
bool ProbeEnabled() {
    static const bool s_enabled = coop::config::ResolveFlag(::coop::config_registry::rows::keypad_probe);
    return s_enabled;
}
...
void Tick() {
    ...
    static const bool sSynth = coop::config::ResolveFlag(::coop::config_registry::rows::keypad_synth);
