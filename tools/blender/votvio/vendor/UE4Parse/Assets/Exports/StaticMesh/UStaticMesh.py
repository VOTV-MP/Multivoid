...
class UStaticMesh(UObject):
    ...
    def deserialize(self, validpos) -> None:
        ...
        if bCooked:
            # VotvIO spike: CUE4Parse gates this on Versions["StaticMesh.KeepMobileMinLODSettingOnDesktop"]
            # (per-game cvar, default OFF) - NOT on game >= 4.27. VotV is cooked without it.
            minMobileLODIdx = 0
