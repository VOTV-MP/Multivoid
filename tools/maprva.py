...
# localization as "ip - modbase") to the enclosing function in the payload .map (main.map).
...
MAP = pathlib.Path(__file__).resolve().parent.parent / "build" / "votv-coop" / "Release" / "main.map"
