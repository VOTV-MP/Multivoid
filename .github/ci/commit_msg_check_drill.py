...
ARMS = [
    ...
    ("verbatim without a speech verb is ordinary English",
     "[net] follow the protocol spec verbatim", False, None, False),
    ("USER", "[docs] a thing\n\nUSER DECISION: keep it", True, "USER", False),
    ("$USER is a shell variable", "[tools] read $USER from the environment", False, None, False),
    ("USER-facing is a compound word", "[ui] fix the USER-facing label", False, None, False),
    ("USER_ID is a field name", "[net] copy the USER_ID field", False, None, False),
