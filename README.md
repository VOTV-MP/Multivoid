...
| | |
|---|---|
| Game classes that can diverge between peers | **1453** (2291 total − 838 with no behaviour of their own) |
| Classes our code names by name | **161** |
| ...of those, carrying a written status | **14** |
| Verified hands-on by a player | **2** |
...
- **161** — a string literal in our source equals the class name. This misses
