...
| 4 | A UE4SS-lane build actually released | **NOT DONE** (re-verified 2026-08-28) — commit 3 LANDED (`1912d229`, §6 item 4 done) and the pipeline is inverted (C3.3); the remaining gate is only §6 item 5, the release itself. The zip exists locally: `Pelmentor-Multivoid-0.9.145.zip` |
