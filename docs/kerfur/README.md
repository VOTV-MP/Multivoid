...
| [03-fix-design-symptoms-1and3-savetime-key-2026-06-24.md](03-fix-design-symptoms-1and3-savetime-key-2026-06-24.md) | FIX DESIGN for 1+3 (off-prop-at-blob): save-time EXACT-position key (L1 Path 1c generalized) + post-quiescence sweep + save-time-keyed RETIRE of a stale local off-prop. Q2 RESOLVED; 4 edges VETTED; CENSUS-PINNED (doc 07) to identity-key + retire requirement VERIFIED (divergence sweep does NOT retire kerfur off-props on a clean bracket). | **DESIGN READY + GREENLIT -> NEXT BUILD (closes forward dup 15:43 + position-skew 15:41)** |
