...
| **ATV** (**CRUTCH C1** -- arc 1 SHIPPED 2026-08-29; **CONDITION lane v147 SHIPPED 2026-08-30 `dcdf665c`** (tires/spare/dirt/fuel/health; presence host-only); still open: eject/putTire intent lane, steering/input class, upgrades/config) | rig pose + velocity, seat, author, neutered collision guard, condition block | 6 | 5U 1V | code+runs | CA/HA | snapshot (pose+velocity+condition) |
