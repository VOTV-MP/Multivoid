...
| `ue_wrap/world/` | world singletons | `daynightcycle`, `skysphere`, `directionalwind`, `game_rules`, `game_mode` (the mode enum and the running world's mode byte), `economy`, `order_economy`, `store_catalog`, `email`, `votv_lib` |
