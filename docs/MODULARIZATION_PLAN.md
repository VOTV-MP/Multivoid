...
>
> Residue >800 after ledger 3 (upd. 07-19 s26): kerfur_convert 1259, harness 1223 (-> B5 axis), autotest_vitals 1013 (flag: the PuppetFrame capture rig is not a vitals test -- split it out first), autotest_chippile 877 (single-feature family, borderline-exempt, watch).
